...
static bool bIsFloorIsLava = false;
static bool bIs999Ammo = false;
static bool bIs999Mats = false;
...
static std::pair<std::string, int> StartingSlot3 = { "FortWeaponRangedItemDefinition /Game/Athena/Items/Consumables/Balloons/Athena_Balloons_Consumable.Athena_Balloons_Consumable", 9 };
