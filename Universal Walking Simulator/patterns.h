...
void InitializePatterns()
{
    ...
    /* if (Engine_Version >= 423)
    {
        ...
        CheckPattern(("FixCrash"), FixCrashAddr, &FixCrash);
    } */
    ...
    if (Engine_Version >= 421 && Engine_Version <= 423)
    {
        ...
        /* if(false) // FnVerDouble >= 8)
        {
            ...
            CheckPattern(("ClientTravel"), ClientTravelAddr, &ClientTravel);
        } */
    }
    ...
    /* if (Engine_Version >= 424)
    {
        ...
        CheckPattern(("SetReplicationDriver"), SetReplicationDriverAddr, &SetReplicationDriver);

        CreateNamedNetDriverAddr = FindPattern(CreateNamedNetDriverSig);
        CheckPattern(("CreateNetDriver_Local"), CreateNamedNetDriverAddr, &CreateNetDriver_Local);
    } */
    ...
    if (Engine_Version >= 424 || Engine_Version < 420 || Engine_Version == 421)
    {
        ...
        if (!CreateNetDriverAddr)
            CreateNetDriverAddr = FindPattern(("48 89 5C 24 ? 57 48 83 EC 30 48 8B 81 ? ? ? ? 49 8B D8 4C 63 81 ? ? ? ?"));

        CheckPattern(("CreateNetDriver"), CreateNetDriverAddr, &CreateNetDriver);

        CreateNetDriver_LocalAddr = FindPattern(CreateNetDriver_Local);

        CheckPattern(("CreateNetDriver_Local"), CreateNetDriver_LocalAddr, &CreateNetDriver_Local); */
    }
    ...
    /* if (Engine_Version >= 424)
    {
        ...
        CheckPattern(("ReplicationGraph_Enable"), ReplicationGraph_EnableAddr, &ReplicationGraph_Enable);

        ValidENameAddr = FindPattern(ValidENameSig);
        CheckPattern(("FromValidEName"), ValidENameAddr, &FromValidEName);
    } */
    ...
    if (Engine_Version < 420)
    {
        ...
        CheckPattern(("SendClientAdjustment"), SendClientAdjustmentAddr, &SendClientAdjustment); */
